import 'package:flutter/gestures.dart'
    show DoubleTapGestureRecognizer, SerialTapDownDetails, SerialTapGestureRecognizer, TapGestureRecognizer;
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return TableView(
      ...
      rowBackgroundBuilder: (context, fileData, rowIndex) {
        return _FileRowBackground(fileData: fileData, index: rowIndex);
      },
      ...
      selectionBuilder: (context) {
        return DecoratedBox(
          decoration: BoxDecoration(
            ...
            // color: Colors.red,
            color: Theme.of(context).colorScheme.primary.withValues(alpha: 0.33),
          ),
        );
      },
    );
